...
class RabbitMQPublisher(MessagePublisher, BaseRabbitMQAdapter):
    def __init__(self):
        BaseRabbitMQAdapter.__init__(self)
    ...
    def close(self) -> None:
        BaseRabbitMQAdapter.close(self)


class RabbitMQConsumer(MessageConsumer, BaseRabbitMQAdapter):
    def __init__(self):
        BaseRabbitMQAdapter.__init__(self)
